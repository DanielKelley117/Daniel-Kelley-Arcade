...
int main() {
    ...
    while ((choice != "q") && (choice != "Q")) {
        cout << "Here is our game selection: Automata, Programming Rumble, Four Corners, Weird Chess" << endl;
        ...
        while ((choice != "automata") && (choice != "Automata") && (choice != "q") && (choice != "Q") && choice != "Programming Rumble" && choice != "programming rumble" && choice != "Programming rumble" && choice != "Four corners" && choice != "Four Corners" && choice != "four corners" && choice != "Weird Chess" && choice != "Weird chess" && choice != "weird chess") {
        ...
        if (choice == "Weird Chess" || choice == "Weird chess" || choice == "weird chess") {
            system(weirdChessCompile.c_str());
            system(weirdChessCommand.c_str());
            points += 200;
        }
